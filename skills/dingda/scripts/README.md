...
```bash
python skills/dingda/scripts/create_feature.py --name myfeature --dry-run
python skills/dingda/scripts/check_architecture.py
python skills/dingda/scripts/generate_tree.py --max-depth 3
```
