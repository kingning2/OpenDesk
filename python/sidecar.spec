...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "channels.ali1688.browser.session",
        "channels.xianyu.login.qrcode",
        "channels.ali1688.login",
        "channels.ali1688.login.qrcode",
        "channels.ali1688.login.probe",
        "channels.ali1688.search",
        "channels.ali1688.search.fetch",
        "channels.ali1688.search.mtop",
