...
交付可演示的商务闭环：YouTube 邮箱获客 → 客户档案 → 自有 SMTP/IMAP 邮件谈价 → AI 只读查库并起草邮件（含纠错记忆）→ WhatsApp Business 桌面辅助（翻译/建议，人发）。
...
| 长期决策 | [ADR-0001](../../decisions/customer/adr-0001-ai-readonly-query-port.md)、[ADR-0005](../../decisions/agent/adr-0005-ai-correction-memory.md) |
...
| [CHG-020 WhatsApp Business 辅助](chg-20260720-020-whatsapp-business-assist.md) | proposed | M5 | CHG-013, CHG-019 | — |
...
- [ ] M4：S3 通过（正式合作字段 + 报价史）
- [ ] M5：S6 + **S6b** 通过（WA 辅助 + **webhook 开发隧道联调**）
